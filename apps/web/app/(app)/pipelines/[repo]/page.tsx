...
const REPO_DATA: Record<string, {
  ...
  'acmecorp/api-gateway': {
    ...
    frameworks: [
      ...
      { name: 'CMMC Level 2', score: 78, controlsTotal: 33, controlsPassing: 26 },
      { name: 'FedRAMP', score: 86, controlsTotal: 35, controlsPassing: 30 },
      { name: 'ASVS', score: 72, controlsTotal: 7, controlsPassing: 5 },
    ],
    findings: [
  ...
  'acmecorp/frontend-app': {
    ...
    frameworks: [
      ...
      { name: 'SOC 2', score: 94, controlsTotal: 7, controlsPassing: 7 },
      { name: 'FedRAMP', score: 88, controlsTotal: 35, controlsPassing: 31 },
      { name: 'CMMC Level 2', score: 85, controlsTotal: 33, controlsPassing: 28 },
    ],
    findings: [
...
const DEFAULT_REPO_DATA = {
  ...
  overallScore: 75,
  frameworks: [
    { name: 'NIST 800-53', score: 75, controlsTotal: 45, controlsPassing: 34 },
    { name: 'SOC 2', score: 80, controlsTotal: 7, controlsPassing: 6 },
  ],
  findings: [],
  recentScans: [],
  resolvedFindings: 10,
