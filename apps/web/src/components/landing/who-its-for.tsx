const personas = [
  ...
  },
  {
    ...
    description: 'CVERiskPilot maps every vulnerability to 10 compliance frameworks — NIST 800-53, CMMC, FedRAMP, SOC 2, HIPAA, PCI-DSS, and more. POAMs generate themselves. Replace the 40-hour quarterly mapping sprint with one command.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
