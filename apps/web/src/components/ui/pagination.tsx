    ...
    <nav className="flex items-center justify-between px-1 py-3" aria-label="Pagination">
      <div className="flex items-center gap-1">
        <button
          ...
          className="inline-flex items-center rounded-md px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-40"
        >
